...
public class Kmeans {
	...
	public final static int pnum = 20000;

	public static Point[] p = new Point[pnum];

	public static void process() {
		String input = "C:/Users/Administrator/Desktop/11/test/yKmeans/data.txt";
		String output1 = "C:/Users/Administrator/Desktop/11/test/yKmeans/out1.txt";
		String output2 = "C:/Users/Administrator/Desktop/11/test/yKmeans/out2.txt";
		try {
		...
		try {
			...
			for (int i = 0; i < k; i++) {
				if (i < 8) {
					for (int j = 0; j < list[i].size(); j++) {
						bw1.write(j+" ");
						bw1.write(list[i].get(j).x + " ");
						bw1.write(list[i].get(j).y+" ");
						bw1.write(i + "\n");
					}
				} else {
					for (int j = 0; j < list[i].size(); j++) {
