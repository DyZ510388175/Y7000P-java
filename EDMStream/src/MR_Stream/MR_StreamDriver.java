...
public class MR_StreamDriver {
	...
	public static void main(String[] args) throws IOException {
		...
		CH = 3.0;
		CL = 0.8;
		lambda = 1.002; //论文中提到的，控制衰落函数
		H = 5;
		beta = 0;
		mu = 2;
//		KDD	covtype	PAMAP2
		input = "G:/workspace/eclipse/result/KDDN.txt";
		dim = 34;//论文中提到的，数据集属性
		//论文中提到的，数据集属性
		epsilon = 5;//for connect the grid no impact with data.
//		KDD99	covtype	PAMAP2
		output = "G:/workspace/eclipse/7-11/result/yMRStream/tmpResult";
		a = 1;//论文中提到的，控制衰落函数
		h = 6;
...
//				System.out.println("endTime:"+end);
				...
				System.out.println((end-start)/25.0);
